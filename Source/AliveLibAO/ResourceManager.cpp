...
struct CamSectorReader
{
    ...
    bool RawFill()
    {
        ...
        // bt1069: back to all-or-nothing. bt1068 bounded this with a memSec so a
        // half-finished PREFETCH could still be used -- correct while there was a
        // prefetch, dead weight now that hardware retired it. A cache entry is
